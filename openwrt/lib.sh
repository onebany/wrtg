...
load_config() {
	...
	WRTG_CF_WORKER_429_COOLDOWN_SEC=""
	WRTG_CF_WORKER_429_MAX_COOLDOWN_SEC=""
	WRTG_CFPROXY_PARALLEL=""
	WRTG_CFPROXY_MAX_ATTEMPTS=""
	WRTG_CFPROXY_FAIL_COOLDOWN_SEC=""
	WRTG_CFPROXY_FAIL_MAX_COOLDOWN_SEC=""
	WRTG_DOH_CACHE_SEC=""
	WRTG_WS_PING_SEC=""
	...
	WRTG_CFPROXY_FAIL_COOLDOWN_SEC=$(printf '%s' "$WRTG_CFPROXY_FAIL_COOLDOWN_SEC" | tr -d '\r')
	WRTG_CFPROXY_FAIL_MAX_COOLDOWN_SEC=$(printf '%s' "$WRTG_CFPROXY_FAIL_MAX_COOLDOWN_SEC" | tr -d '\r')
