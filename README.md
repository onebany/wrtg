...
**Version:** 0.5.17 · **Last updated:** 2026-07-12
...
Опции через env: `VER=v0.5.17`, `WRTG_REPO=owner/repo` (другой GitHub-репо), `WRTG_BASE_URL=` (self-hosted Gitea), `ASSUME_YES=1`, `SKIP_LUCI=1`, `CF_WORKER_DOMAIN=…`.
